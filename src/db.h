...
#define COUNT_PLAYLIST_RELATIONS "SELECT COUNT(*) FROM PLAYLIST_SONG"
#define ADD_SONG_PLAYLIST "INSERT INTO PLAYLIST_SONG VALUES(?,?,?)"
#define VIEW_PLAYLIST_SONGS "SELECT * FROM PLAYLIST_SONG WHERE relation_uuid=?"
...
#define DELETE_DB_URL  "DELETE FROM YOUTUBE_URL where url=?" 
